...
function CreateDataItem({ onChangeApiState }) {
  ...
  return (
    <>
      ...
      <form className="addNewItems w-50 d-flex m-auto flex-column" onSubmit={handleSubmit(onSubmit)}>
        <input
        style={width}
          type="text"
          {...register("name")}
        ...
        style={width}
          type="file"
          {...register("succesfullPlans")}
          placeholder="Succesfull Plans*"
          required
        />
        <input
        style={width}
